...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.strength.hasOwnProperty('selectConnection'))
                ...
                */
                ...
                var linkLeft = svgLeft.selectAll(".link")
                    ...
                    .style("stroke", function(d){//路径颜色
                        return that.fillScaleRed(d.accuracy, 1);
                    })
                    ...
                    .on("mouseenter", function(d, i) {
                        ...
                        return tipsDiv
                            ...
                            .html('ROI: ' + (d.source.index + 1) + '  <->  ' + (d.target.index + 1) + '<br>' + 'accuracy: ' + d.accuracy + '<br>' + 'value: ' + d.thick.toFixed(5) + '<br>');//tooltip.html(text);
                    })
