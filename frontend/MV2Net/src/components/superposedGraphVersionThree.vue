...
<template>
    <div style="text-align: left; padding-top: 5px; padding-bottom: 5px;">
        <div :class='setClass()' style="height:50%;">  
            <div class="panel" ref="myPanel" style="overflow: visible; width: 100px; float: left; font-size: 5px;">
                ...
                <slider :min=0 :max=100 v-model="filterRate[0]" :dataMin="origindata_range.r1.toFixed(1)" :dataMax="origindata_range.r2.toFixed(1)" :style="{'width': '95px'}"></slider>
                <!--div>
            ...
            <div style="position: absolute; top: 40px; padding-left: 10px; z-index: 999;">
                <div>
            ...
            <div class="leftSVG" style="padding-left: 18px; padding-top: 37px;">
                <div class="tipsDiv" style="z-index: 0; color: black; font-size: 10px; text-align: right;  position: relative;visibility: hidden; height: 0px;"></div>
            </div>
...
<script>
    ...
    //import $ from "jquery"
    export default {
        name: 'superposedGraphVersionThree',
        components: {
            slider,
        },
        props: {
        ...
        methods: {
            ...
            drawSidBySidePic(){
                ...
                */
                ...
                for(var i = 0; i < this.strength.data.length; i++) {
                    if (Math.abs(this.strength.data[i]) >= fillMin) {
                ...
                var linkLeft2 = svgLeft.selectAll(".link2")
                    ...
                    .on("mouseenter", function(d, i) {
                        ...
                        return tipsDiv
                            ...
                            .style('right', '5px') //14
                            .style('top', '160px') //224
                            .html(that.featureName + ':<br>' + 'ROI: ' + (d.source.index + 1) + '  <->  ' + (d.target.index + 1) + '<br>' + 'value: ' + d.thick.toFixed(5) + '<br>' + 'originvalue: ' + d.origindata.toFixed(5));//tooltip.html(text);
                    })
                    .on("mouseout", function(d, i) {
                        //return tooltip.style('visibility', 'hidden');
                        return tipsDiv.style('visibility', 'hidden');
