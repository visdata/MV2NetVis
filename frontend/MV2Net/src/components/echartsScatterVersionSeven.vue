<template>
    <div>
        <div class="col-3" style="border-right: 1px solid rgba(0, 0, 0, 0.1); padding: 0px;">
        <div>
    ...
    <div class="col-9" style="border-right: 1px solid rgba(0, 0, 0, 0.1); padding: 0px;">
        <div>
        <div class="card border-light mb-3">
            ...
            <div class="card-body">
                ...
                <div :style="{'margin-top': '-8px', 'width':'39px', 'float':'left'}">
                    <div>
                        ...
                        <slider :min=-0.000001 :max=100 v-model="pValueThreshold" :style="{'width': '100px'}"></slider>
                    ...
                    <div>
                        ...
                        <slider :min=-0.000001 :max=100 v-model="validThreshold" :style="{'width': '100px'}"></slider>
                        <!--Slider v-model='validThreshold' :showTip="true" :rule="[0, '|', 25, '|',50, '|', 75, '|', 100]" style="width: 150px" :step='20'></Slider-->
                    </div>
                </div>
                <!--第一列下热力图-->
                <div :style="{'height': '220px', 'width': '300px','float':'left'}">
...
<script>
    ...
    export default {
        name: "echartsScatterVersionSeven",
        components: {
            breadcrumbTrail,
            highlightOnHover,
            nodeInfoDisplayer,
