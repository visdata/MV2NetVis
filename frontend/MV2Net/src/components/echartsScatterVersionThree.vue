<template>
    ...
    <h5>Subject View</h5>
    <!--选择性别还是是否患病-->
    <div :style="{'margin-top': '-10px', 'position':'absolute', 'padding-left': '70%', 'z-index': '99'}">
    ...
    <!--第一列上sunburst-->
    <sunburst-two :data="sunburstData" :show='true' :style="{'margin-top': '-10px','height': '350px'}" >
        <!-- Add behaviors -->
    ...
    <h5>Feature View</h5>
    <div :style="{'min-height': '56px', 'margin-top': '-8px'}">
...
<script>
    ...
    export default {
        name: "echartsScatterVersionThree",
        components: {
            breadcrumbTrail,
            highlightOnHover,
            nodeInfoDisplayer,
        ...
        mounted() {
            ...
            [
                ...
                [0.2,0.4,0.5,0.3,0.4,'b'],
                [0.1,0.4,0.7,0.4,0.5,'c']
            ],
            [
                [0.2,0.4,0.4,0.5,0.3,'d'],
                [0.4,0.3,0.1,0.4,0.5,'e'],
                [0.4,0.5,0.5,0.7,0.3,'f']
            ],
            [
                [0.4,0.5,0.2,0.4,0.2,'h'],
                [0.4,0.5,0.4,0.3,0.7,'i'],
                [0.4,0.5,0.5,0.7,0.7,'j']
            ]];
           var down = [
            [
                [0.2,0.4,0.1,0.2,0.3,'a'],
                [0.2,0.3,0.2,0.4,0.4,'b'],
                [0.1,0.4,0.7,0.2,0.4,'c']
            ],
            [
                [0.2,0.4,0.3,0.2,0.4,'d'],
                [0.4,0.3,0.1,0.2,0.4,'e'],
                [0.5,0.7,0.3,0.2,0.4,'f']
            ],
            [
                [0.2,0.4,0.2,0.4,0.2,'h'],
                [0.4,0.3,0.2,0.4,0.7,'i'],
                [0.5,0.7,0.7,0.2,0.4,'j']
            ],
            [
                [0.2,0.4,0.7,0.2,0.4,'k'],
                [0.4,0.3,0.2,0.4,0.7,'l'],
                [0.5,0.7,0.7,0.2,0.4,'m']
            ]];
            */
            /*
            var up =[];
            ...
            */
            ...
            this.setOptionTrans(this.pValueDataUp, this.pValueDataBottom, 0);
            this.setOptionTrans(this.pValueDataUp, this.pValueDataBottom, 1);
            this.setOptionTrans(this.pValueDataUp, this.pValueDataBottom, 2);
            this.setOptionTrans(this.pValueDataUp, this.pValueDataBottom, 3);
            this.setOptionTrans(this.pValueDataUp, this.pValueDataBottom, 4);
            */
            /*
        ...
        methods: {
            ...
            setOptionTrans(pointUp, pointBottom, index){
                //point为三维数组,index指示某一列为该特征
                //var point = [[[0.1,0.2,0.3,'a'],[0.2,0.3,0.4,'b'],[0.1,0.4,0.7,'c']],[[0.2,0.4,0.3,'d'],[0.4,0.3,0.1,'e'],[0.5,0.7,0.3,'f']],[[0.2,0.4,0.2,'h'],[0.4,0.3,0.7,'i'],[0.5,0.7,0.7,'j']]];
                //var index = 2;
                //深度拷贝,拷贝下半部分
        ...
        watch: {
            ...
            selected_subjects: {
                ...
                handler: function(newVal, oldVal) {
                    if(newVal.length == 2){
                        NetService.getPValueData(this.values, (res, err) => {
                            if(err){
                                console.error(err);
                                return;
                            }
