...
<script>
    ...
    //import $ from "jquery"
    export default {
        name: 'superposedGraphForMultiVersionTwo',
        components: {
            slider,
        },
        props: {
        ...
        methods: {
            ...
            drawSidBySidePic(){
                ...
                */
                ...
                for(var i = 0; i < this.strength.multidata.length; i++) {
                    if (this.strength.selectConnection[i] > 0 && Math.abs(this.strength.multidata[i] >= fillMin) && Math.abs(this.strength.multidata[i]) <= fillMax) {
