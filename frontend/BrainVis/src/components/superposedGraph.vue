...
<template>
    <div style="text-align: left; padding-top: 5px; padding-bottom: 10px;">
        <div :class='setClass()' style="height:50%;">  
            <div class="panel" ref="myPanel" style="overflow: visible; width: 80px; float: left; ">
                ...
                <slider :min=-0.00001 :max=100 v-model="filterRate[1]" :style="{'width': '70px'}"></slider>
...
<script>
    ...
    export default {
        ...
        mounted() {
            if(this.strength.hasOwnProperty('pvalue'))
        ...
        methods: {
            ...
            drawSidBySidePic(){
                ...
                */
                ...
                fillMin = this.filterRate[0] * (this.weight_range.r2 - this.weight_range.r1) / 100 + this.weight_range.r1;
                fillMax = this.filterRate[1] * (this.weight_range.r2 - this.weight_range.r1) / 100 + this.weight_range.r1;
                ...
                var linkLeft = svgLeft.selectAll(".link")
                    ...
                    .style("stroke", function(d){//路径颜色
                        if(d.weight >= fillMin && d.weight <= fillMax){
                            if(d.groupOneData >= d.groupTwoData){
                                return that.fillScaleRed(d.weight - fillMin, fillMax - fillMin);
                                ...
                                return that.fillScaleGreen(d.weight - fillMin, fillMax - fillMin);   
                    ...
                    .style("stroke-opacity", function(d){ //不透明度
                        ...
                        if (d.weight < (that.weight_range.r2 - that.weight_range.r1) * that.filterThreshold + that.weight_range.r1) {
                            return 0;
                        }
                        if (d.weight < fillMin) {
                            return 0.5;
                    ...
                    .on("mouseenter", function(d, i) {
                        ...
                        return tipsDiv
                            ...
                            .html('ROI: ' + (d.source.index + 1) + '  <->  ' + (d.target.index + 1) + '<br>' + 'p-value: ' + d.weight.toFixed(5) + '<br>' + 'value: ' + d.thick.toFixed(5) + '<br>' + 'GroupOneData: ' + d.groupOneData.toFixed(5) + '<br>' + 'GroupTwoData: ' + d.groupTwoData.toFixed(5));//tooltip.html(text);
                    })
        ...
        watch: {
            ...
            filterRate: {
                ...
                handler: function(newVal, oldVal) {
                    ...
                    var that = this;
                    var fillMin = newVal[0] * (that.weight_range.r2 - that.weight_range.r1) / 100 + that.weight_range.r1;
                    var fillMax = newVal[1] * (that.weight_range.r2 - that.weight_range.r1) / 100 + that.weight_range.r1;
