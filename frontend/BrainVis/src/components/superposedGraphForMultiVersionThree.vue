...
<template>
    <div style="text-align: left; padding-bottom: 5px;">
        <div :class='setClass()' style="height:50%;">  
            <div class="panel" ref="myPanel" style="overflow: visible; width: 100px; float: left; font-size: 5px; padding-top: 6px;">
                <slider :min=0 :max=100 v-model="filterRate[0]" :dataMin="thick_range.r1.toFixed(1)" :dataMax="thick_range.r2.toFixed(1)" :ispvalue="Func == 'pvalue' ? 1 : 0" :style="{'width': '95px'}"></slider>
                <!--div>
            ...
            <div style="position: absolute; top: 317px; padding-left: 10px; z-index: 999;">
                <div>
            ...
            <div class="leftSVG" style="padding-left: 18px; padding-top: 37px;">
                <div class="tipsDiv" style="z-index: 10; color: black; font-size: 12px; text-align: right;position: relative;visibility: hidden; height: 0px;"></div>
            </div>
...
<script>
    ...
    //import $ from "jquery"
    export default {
        name: 'superposedGraphForMultiVersionThree',
        components: {
            slider,
        },
        props: {
                ...
                var linkLeft2 = svgLeft.selectAll(".link2")
                    ...
                    .on("mouseenter", function(d, i) {
                        ...
                        return tipsDiv
                            ...
                            //.style('top', '224px')
                            .style('top', '180px')
                            .html(that.featureName + ':<br>' + 'ROI: ' + (d.source.index + 1) + '  <->  ' + (d.target.index + 1) + '<br>' + 'multivalue: ' + d.thick.toFixed(5) + '<br>');//tooltip.html(text);
                    })
