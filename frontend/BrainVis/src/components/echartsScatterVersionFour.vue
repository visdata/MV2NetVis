<template>
    ...
    <div :style="{'min-height': '56px', 'margin-top': '-8px'}">
        <div :style="{'display':'inline', 'width':'150px', 'float':'left'}">
            ...
            <Slider v-model='pValueThreshold' :showTip="true" :rule="[0, '|', 25, '|',50, '|', 75, '|', 100]" style="width: 150px"></Slider>
        </div>
        <div :style="{'display':'inline', 'width':'180px', 'float':'left','padding-left':'30px'}">
            ...
            <Slider v-model='validThreshold' :showTip="true" :rule="[0, '|', 25, '|',50, '|', 75, '|', 100]" style="width: 150px"></Slider>
        </div>
    </div>
    <!--第一列下热力图-->
...
<script>
    ...
    export default {
        name: "echartsScatterVersionFour",
        components: {
            breadcrumbTrail,
            highlightOnHover,
            nodeInfoDisplayer,
