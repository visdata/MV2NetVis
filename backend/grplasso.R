...
write_json(coefficients(fit)[,6],paste('cache/lass_coef_',fid,z_thes,db_thes,sub1,sub2,'.json',sep=""))
write_json(lambda,paste('cache/lambda_',fid,z_thes,db_thes,sub1,sub2,'.json',sep=""))
